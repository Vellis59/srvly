...
export default function SettingsPage() {
  ...
  const promptText = [
    ...
    "6. Run an independent post-deploy healthcheck after docker/deploy returns; do not rely only on the API response",
    "7. If a domain is configured, verify HTTPS is reachable after Caddy reload before reporting success",
    "8. Configure domain/SSL if requested (via Caddy, never manually configure nginx)",
    "9. Confirm when done and provide access URL",
    "",
    "## API Documentation",
