...
export default function SettingsPage() {
  ...
  const promptText = [
    ...
    "3. If the app has prerequisites, create them first with POST " + baseUrl + "/api/dispatch using { serverId, script, timeout }",
    ...
    "6. Run the recipe healthcheck and only report success after it passes",
    "7. Configure domain/SSL if requested (via Caddy, never manually configure nginx)",
    "8. Confirm when done and provide access URL",
    "",
    "## API Documentation",
