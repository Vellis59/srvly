      ...
      <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-10 w-full max-w-sm shadow-2xl text-center">
        ...
        <div className="flex flex-col gap-3">
          <button
            ...
            className="w-full py-3 bg-white text-slate-900 rounded-xl font-medium hover:bg-zinc-200 transition-colors flex items-center justify-center gap-2"
          >
        ...
        <div className="flex justify-center gap-4 mt-6 text-xs text-zinc-500">
